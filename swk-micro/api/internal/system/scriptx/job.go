...
func Init() {
	...
	script20240712, err := ioutil.ReadFile("assets/scripts/script20240712.js")
	if err != nil {
		panic(err)
	}
	...
	list = append(list, script.AddRequest{
		ScriptId:      "0419",
		ScriptName:    "台帳情報の一意のフィールド情報を追加する",
	...
	list = append(list, script.AddRequest{
		ScriptId:      "20220616",
		ScriptName:    "承認のために承認履歴情報のストレージを変更する",
	...
	// 2024-07-12 インデックスの追加
	list = append(list, script.AddRequest{
		ScriptId:      "20240712",
		ScriptName:    "インデックスの追加",
		ScriptDesc:    "インデックスの追加",
		ScriptType:    "javascript",
		ScriptData:    "{\"db\":\"pit\"}",
		ScriptFunc:    string(script20240712),
		ScriptVersion: "2.4.7",
