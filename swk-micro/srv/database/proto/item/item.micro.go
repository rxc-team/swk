...
type ItemService interface {
	...
	ImportCSVItem(ctx context.Context, in *ImportCSVRequest, opts ...client.CallOption) (*ImportCSVResponse, error)
	ImportINVItem(ctx context.Context, in *ImportINVRequest, opts ...client.CallOption) (*ImportINVResponse, error)
	ImportMappingItem(ctx context.Context, in *ImportMappingRequest, opts ...client.CallOption) (*ImportMappingResponse, error)
}
...
func (c *itemService) ImportCSVItem(ctx context.Context, in *ImportCSVRequest, opts ...client.CallOption) (*ImportCSVResponse, error) {
	req := c.c.NewRequest(c.name, "ItemService.ImportCSVItem", in)
...
func (c *itemService) ImportINVItem(ctx context.Context, in *ImportINVRequest, opts ...client.CallOption) (*ImportINVResponse, error) {
	req := c.c.NewRequest(c.name, "ItemService.ImportINVItem", in)
	out := new(ImportINVResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *itemService) ImportMappingItem(ctx context.Context, in *ImportMappingRequest, opts ...client.CallOption) (*ImportMappingResponse, error) {
	req := c.c.NewRequest(c.name, "ItemService.ImportMappingItem", in)
	out := new(ImportMappingResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type ItemServiceHandler interface {
	...
	ImportCSVItem(context.Context, *ImportCSVRequest, *ImportCSVResponse) error
	ImportINVItem(context.Context, *ImportINVRequest, *ImportINVResponse) error
	ImportMappingItem(context.Context, *ImportMappingRequest, *ImportMappingResponse) error
}
...
func RegisterItemServiceHandler(s server.Server, hdlr ItemServiceHandler, opts ...server.HandlerOption) error {
	type itemService interface {
		...
		ImportCSVItem(ctx context.Context, in *ImportCSVRequest, out *ImportCSVResponse) error
		ImportINVItem(ctx context.Context, in *ImportINVRequest, out *ImportINVResponse) error
		ImportMappingItem(ctx context.Context, in *ImportMappingRequest, out *ImportMappingResponse) error
	}
	type ItemService struct {
		itemService
	}
...
func (h *itemServiceHandler) ImportCSVItem(ctx context.Context, in *ImportCSVRequest, out *ImportCSVResponse) error {
	return h.ItemServiceHandler.ImportCSVItem(ctx, in, out)
}

func (h *itemServiceHandler) ImportINVItem(ctx context.Context, in *ImportINVRequest, out *ImportINVResponse) error {
	return h.ItemServiceHandler.ImportINVItem(ctx, in, out)
}

func (h *itemServiceHandler) ImportMappingItem(ctx context.Context, in *ImportMappingRequest, out *ImportMappingResponse) error {
	return h.ItemServiceHandler.ImportMappingItem(ctx, in, out)
}
